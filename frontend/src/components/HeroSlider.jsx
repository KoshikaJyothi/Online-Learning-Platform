function HeroSlider() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-[#dfe1e8] bg-linear-to-br from-[#fff5f7] via-[#f6f9ff] to-[#eef8f7] p-5 sm:p-8 lg:p-14">
      ...
      <div className="relative grid items-center gap-8 lg:gap-10 lg:grid-cols-2">
        <div>
          ...
          <h1 className="max-w-xl text-3xl font-black leading-tight text-[#1c1d1f] sm:text-4xl lg:text-5xl">
            Skills that move your career forward.
          </h1>
          <p className="mt-4 max-w-xl text-sm text-[#3e4143] sm:text-base lg:text-lg">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4 sm:gap-6 text-sm text-[#4d5156]">
        ...
        <div className="rounded-2xl border border-[#d9dbe3] bg-white p-3 sm:p-4 shadow-[0_20px_50px_-24px_rgba(17,24,39,0.45)]">
          <img
            src="https://img.freepik.com/free-photo/programmer-working-computer-office_1098-18699.jpg"
            alt="Students learning online"
            className="h-56 w-full rounded-xl object-cover sm:h-72 lg:h-85"
          />
        </div>
      </div>

      <div className="relative mt-8 sm:mt-10 rounded-2xl border border-[#eceef3] bg-white px-4 py-5 lg:px-8">
        <p className="text-center text-sm font-medium text-[#6a6f73]">
          Trusted by teams at
        </p>
        <div className="mt-4 grid grid-cols-2 gap-3 text-center text-xs sm:text-sm font-semibold uppercase tracking-[0.08em] text-[#2d2f31] md:grid-cols-5">
          <span>Acme Corp</span>
          <span>InnoSoft</span>
